...
namespace wiscdb {
    ...
    static_assert(Page::SIZE > sizeof(PageHeader),
        "El tamaño de la página debe ser lo suficientemente grande para contener el encabezado y los datos.");
    static_assert(Page::DATA_SIZE > 0,
        "La página debe tener algo de espacio para almacenar datos.");
